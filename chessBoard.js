class Chessboard {
    ...
    addStyles() {
        let e = `.board{display:flex;flex-direction:column;justify-content:center;position:relative;}.chessboard{aspect-ratio:1/1;display:flex;flex-wrap:wrap;border-radius:0.25em;overflow:hidden;position:relative;}.square{width:calc(100%/8);height:calc(100%/8);cursor:grab;position:relative;display:flex;justify-content:center;align-items:center;}.sparePieces{width:calc(600%/8);aspect-ratio:4/1;}.sparePieces img{aspect-ratio:1/1;width:calc(90%/6);cursor:grab;}.chessPiece{width:90%;aspect-ratio:1/1;cursor:grab;z-index:100;transition:transform 0.5s ease-in;position:relative;}.square.hovered{box-shadow:inset 0 0 0.6em rgb(99,234,75);}.dragging{cursor:grabbing;z-index:1000;}.buttons{height:50px;width:50px;;}.file{display:flex;justify-content:center;align-items:center;width:25%;height:25%;font-family:Arial,Helvetica,sans-serif;font-size:0.7em;font-weight:600;position:absolute;bottom:2%;right:0;}.rank{display:flex;justify-content:center;align-items:center;width:25%;height:25%;font-size:0.8em;font-weight:600;position:absolute;top:5%;left:0;}.fade-out{animation:fadeOut 0.6s forwards;}@keyframes fadeOut{from{opacity:1;}
  to{opacity:0;}}.square.analysisW{background-color:#EB7D6A!important;}.square.analysisB{background-color:#D36C50!important;}.circle{width:35%;height:35%;border-radius:50%;background-color:black;opacity:0.2;}.ring{width:80%;height:80%;border:0.25em solid#000000;border-radius:50%;opacity:0.2;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);}.board,
  .image {-webkit-user-select: none;/* Chrome/Safari */-moz-user-select: none;/* Firefox */-ms-user-select: none;/* IE10+ */user-select: none; /* Standard */}
  `,
